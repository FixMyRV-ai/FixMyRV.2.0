...
<body>
    <div class="email-container">
        ...
        try {
            await emailService.sendEmail(user.email, "Verify Your Email - Fix My RV", emailTemplate);
        }
        catch (error) {
...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            ...
            await emailService.sendEmail(user.email, "Password Reset - Fix My RV", emailTemplate);
