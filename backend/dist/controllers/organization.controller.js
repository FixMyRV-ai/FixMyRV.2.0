...
class OrganizationController {
    constructor() {
        ...
        // Delete organization
        this.deleteOrganization = async (req, res) => {
            try {
                const { id } = req.params;
                const organization = await Organization.findByPk(id);
                if (!organization) {
        ...
        this.getOrganizationUsers = async (req, res) => {
            try {
                const { id } = req.params;
                const { page = 1, limit = 10 } = req.query;
                const pageNumber = parseInt(page, 10);
        ...
        this.addUserToOrganization = async (req, res) => {
            try {
        ...
        this.removeUserFromOrganization = async (req, res) => {
            try {
